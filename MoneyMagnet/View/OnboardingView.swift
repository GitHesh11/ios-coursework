            ...
            VStack {
                ...
                HStack(alignment: .center, spacing: 5) {
                    Circle()
                        ...
                        .foregroundColor(currentIndex == 0 ? Color("ThemeColor") : .gray)
                        .scaleEffect(currentIndex == 0 ? 1.2 : 0.8)
                    Circle()
                        .frame(width: 12, height: 12)
                        .foregroundColor(currentIndex == 1 ? Color("ThemeColor") : .gray)
                        .scaleEffect(currentIndex == 1 ? 1.2 : 0.8)
                    Circle()
                        .frame(width: 12, height: 12)
                        .foregroundColor(currentIndex == 2 ? Color("ThemeColor") : .gray)
